...
Inline view templates are used to define reusable markup without defining a
separate partial view template. They can be used to define inline partials or
even inline layout templates.
